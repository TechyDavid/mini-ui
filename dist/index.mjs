import React2, { createContext, useState, useEffect, useMemo, useContext } from 'react';
import { jsxs, jsx } from 'react/jsx-runtime';
import './styles-JF6KF7YO.css';
...
var Box = ({ as = "div", children, style, p, px, py, m, display, w, h, bg, color, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Tag, { style: resolvedStyle, ...rest, children });
};
var Button = React2.forwardRef(
  ({ variant = "solid", size = "md", color = "var(--ui-color-primary)", loading, leftIcon, rightIcon, children, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("button", { ref, className, style, disabled: rest.disabled || loading, ...rest, children: [
      loading ? /* @__PURE__ */ jsx("span", { className: "ui-btn__spinner", "aria-hidden": true }) : leftIcon ? /* @__PURE__ */ jsx("span", { className: "ui-btn__icon", children: leftIcon }) : null,
      /* @__PURE__ */ jsx("span", { className: "ui-btn__label", children }),
      rightIcon ? /* @__PURE__ */ jsx("span", { className: "ui-btn__icon", children: rightIcon }) : null
    ] });
  }
);
Button.displayName = "Button";

export { Box, Button, ThemeProvider, createTheme, cssVarsFromTheme, defaultDarkTheme, defaultLightTheme, generateCssVarsStyleTag, useTheme, useThemeProviderContext };
